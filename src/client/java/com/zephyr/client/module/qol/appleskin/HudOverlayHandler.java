...
public class HudOverlayHandler {
    ...
    public void drawSaturationOverlay(GuiGraphics graphics, float saturationGained, float saturationLevel,                                      Player player, int right, int top, float alpha, int guiTicks) {
        ...
        for (int i = startSaturationBar; i < endSaturationBar; ++i) {
            ...
            graphics.blit(TextureHelper.MOD_ICONS, x, y, u, v, iconSize, iconSize, 256, 256);
            graphics.setColor(1.0F, 1.0F, 1.0F, 1.0F);
        }
    }

    public void drawHungerOverlay(GuiGraphics graphics, int hungerRestored, int foodLevel,
        ...
        for (int i = startFoodBars; i < endFoodBars; ++i) {
            ...
            graphics.setColor(1.0F, 1.0F, 1.0F, alpha * 0.25F);
            graphics.blitSprite(backgroundSprite, x, y, iconSize, iconSize);
            graphics.setColor(1.0F, 1.0F, 1.0F, 1.0F);
            ...
            graphics.setColor(1.0F, 1.0F, 1.0F, alpha);
            graphics.blitSprite(iconSprite, x, y, iconSize, iconSize);
            graphics.setColor(1.0F, 1.0F, 1.0F, 1.0F);
        }
    }

    public void drawHealthOverlay(GuiGraphics graphics, float health, float modifiedHealth,
    ...
    public void drawExhaustionOverlay(GuiGraphics graphics, float exhaustion, int right, int top, float alpha) {
        ...
        graphics.setColor(1.0F, 1.0F, 1.0F, alpha);
        graphics.blit(TextureHelper.MOD_ICONS, right - width, top, 81 - width, 18, width, height, 256, 256);
        graphics.setColor(1.0F, 1.0F, 1.0F, 1.0F);
    }
