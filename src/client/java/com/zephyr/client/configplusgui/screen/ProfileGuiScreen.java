...
public final class ProfileGuiScreen extends ZephyrScreen {
    ...
    private void renderRow(GuiGraphics graphics, Row row, int scroll, int mouseX, int mouseY) {
        ...
        if (!renaming) {
            ...
            graphics.drawString(this.font, row.name, panelX + PADDING + 8, top + 9, nameColor, false);
        }
        ...
        graphics.drawCenteredString(this.font, "R", renameX + ICON_BOX_SIZE / 2, renameY + 1,
        ...
        if (showDelete) {
            ...
            graphics.drawCenteredString(this.font, "x", deleteX + ICON_BOX_SIZE / 2, renameY + 1, TEXT_DIM);
        }
    }
