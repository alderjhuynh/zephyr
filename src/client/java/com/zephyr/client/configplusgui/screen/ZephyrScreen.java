...
public abstract class ZephyrScreen extends Screen {
    ...
    public void renderBackground(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        // Vanilla blurs the world behind every in-game screen; Zephyr skips the blur
        // pass so the game stays sharp behind the panel and just darkens it instead.
    ...
    /** Centered (no shadow) text helper, mirroring the newer GUI APIs' centeredText(). */
    protected void centeredText(GuiGraphics graphics, Font font, String text, int centerX, int y, int color) {
        graphics.drawString(font, text, centerX - font.width(text) / 2, y, color, false);
    }

    protected void renderChrome(GuiGraphics graphics, int mouseX, int mouseY) {
        ...
        graphics.drawString(this.font, "ZEPHYR", panelX + PADDING, titleY, accent(), false);
        ...
        graphics.drawString(this.font, indicator, indicatorX, indicatorY, TEXT_DIM, false);
    }
