...
public final class SecretGuiScreen extends ZephyrScreen {
    ...
    private void renderRow(GuiGraphics graphics, Row row, int scroll, int mouseX, int mouseY) {
        ...
        if (row instanceof SectionHeader header) {
            ...
            graphics.drawString(this.font, header.label, panelX + PADDING + 8, top + 7, TEXT_DIM, false);
    ...
    private void renderToggle(GuiGraphics graphics, ToggleRow toggle, int top, int mouseX, int mouseY) {
        ...
        graphics.drawString(this.font, toggle.label, panelX + PADDING + 8, top + 9, nameColor, false);
    ...
    private void renderStat(GuiGraphics graphics, StatRow stat, int top) {
        graphics.fill(panelX + PADDING, top, panelX + panelWidth - PADDING, top + ROW_HEIGHT, ROW_BG);
        graphics.drawString(this.font, stat.label, panelX + PADDING + 8, top + 9, TEXT_DIM, false);
