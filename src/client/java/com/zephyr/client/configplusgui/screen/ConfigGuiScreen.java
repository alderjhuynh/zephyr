...
public final class ConfigGuiScreen extends ZephyrScreen {
    ...
    private void renderRow(GuiGraphics graphics, Row row, int mouseX, int mouseY) {
    ...
    private void renderSettingRow(GuiGraphics graphics, Setting<?> setting, int top, int mouseX, int mouseY) {
    ...
    private void renderBooleanRow(GuiGraphics graphics, BooleanSetting setting, int top, int mouseX, int mouseY) {
        ...
        graphics.drawString(this.font, setting.getName(), panelX + PADDING + 8, top + 9, nameColor, false);
    ...
    private void renderSliderRow(GuiGraphics graphics, String label, NumberSetting setting, int top, int mouseX, int mouseY) {
        boolean hovered = isHovered(mouseX, mouseY, top);
        ...
        graphics.drawString(this.font, labelText, panelX + PADDING + 8, top + 5, TEXT_MAIN, false);
    ...
    private void renderEnumRow(GuiGraphics graphics, String label, EnumSetting<?> setting, int top, int mouseX, int mouseY) {
        boolean hovered = isHovered(mouseX, mouseY, top);
        graphics.fill(panelX + PADDING, top, panelX + panelWidth - PADDING, top + ROW_HEIGHT,
                hovered ? ROW_BG_HOVER : ROW_BG);

        graphics.drawString(this.font, label, panelX + PADDING + 8, top + 9, TEXT_MAIN, false);

        String value = setting.getDisplayValue();
        int valueWidth = this.font.width(value);
        graphics.drawString(this.font, value, panelX + panelWidth - PADDING - 8 - valueWidth, top + 9, accent(), false);
    }

    private void renderStringRow(GuiGraphics graphics, String label, StringSetting setting, int top) {
        ...
        int valueWidth = this.font.width(value);
        graphics.drawString(this.font, value, panelX + panelWidth - PADDING - 8 - valueWidth, top + 9, TEXT_DIM, false);
    }

    private void renderListRow(GuiGraphics graphics, String label, ListSetting setting, int top) {
        graphics.fill(panelX + PADDING, top, panelX + panelWidth - PADDING, top + ROW_HEIGHT, ROW_BG);
    ...
    private void renderThemeRow(GuiGraphics graphics, int top, int mouseX, int mouseY) {
        boolean hovered = isHovered(mouseX, mouseY, top);

        graphics.fill(panelX + PADDING, top, panelX + panelWidth - PADDING, top + ROW_HEIGHT,
                hovered ? ROW_BG_HOVER : ROW_BG);

        graphics.drawString(this.font, "Theme Color", panelX + PADDING + 8, top + 9, TEXT_MAIN, false);
        ...
        int valueWidth = this.font.width(value);
        graphics.drawString(this.font, value, valueRight - valueWidth - swatchSize - 6, top + 9, accent(), false);
    }

    private void renderColorRow(GuiGraphics graphics, int top, int mouseX, int mouseY) {
        ...
        graphics.drawString(this.font, label, left + 52, swatchTop + (SWATCH_HEIGHT - 8) / 2, TEXT_MAIN, false);

        String hex = String.format("#%06X", accentColor & 0xFFFFFF);
        int hexWidth = this.font.width(hex);
        graphics.drawString(this.font, hex, right - hexWidth, swatchTop + (SWATCH_HEIGHT - 8) / 2, TEXT_DIM, false);
    }
